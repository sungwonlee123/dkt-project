"""
Self-Attentive Knowledge Tracing (SAKT) Model Implementation - Model 1
                ...
                for data in test_loader:
                    ...
                    if i == num_epochs:
                        try:
                            ...
                            att_fig, basic_attention_matrix, original_attention_matrix, problem_labels = visualize_skillbuilder_attention_patterns(self, dataset, return_matrix=True, model_name='model1')
                            att_fig.savefig('attention_heatmap_global_model1_basic.png', bbox_inches='tight', dpi=300)
                            ...
                            enhanced_fig.savefig('attention_heatmap_global_model1_enhanced.png', bbox_inches='tight', dpi=300)
                            print("Enhanced global attention visualization saved")
                            
                            # 전체 데이터 기반 관계 그래프
                            graph_fig = visualize_global_relationship_graph(self, dataset)
                            graph_fig.savefig('attention_graph_global_model1.png', bbox_inches='tight', dpi=300)
                            print("Global relationship graph saved")
                            
                            # 개선된 결과 요약
                            print(f"\n=== Model 1 개선된 영향도 분석 결과 ===")
